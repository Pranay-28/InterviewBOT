  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
          ...
          <nav className={`hidden md:flex flex-grow justify-center`}>
            <ul className="flex space-x-4">
              ...
              <li className={`hover:text-primary font-bold transition-all cursor-pointer ${path === '/question' && 'text-primary font-bold'}`}>
      ...
      <main className="container mx-auto mt-16 px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">Question Page</h1>
