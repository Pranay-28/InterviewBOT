...
function page({params}) {
  ...
  return (
    <div className='p-10'>
      ...
      <h2>Find below interview question, possible correct answer, your answer and feedback.</h2>
      {feedbackList&&feedbackList.map((item, index)=> (
        ...
        <CollapsibleContent>
         <div className='flex flex-col gap-2'>
            ...
            <h2 className='p-2 border rounded-lg bg-green-50 text-sm text-green-900-900'><strong>Possible correct answer: </strong>{item.correctAns}</h2>
